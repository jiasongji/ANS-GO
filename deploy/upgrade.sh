#!/usr/bin/env bash
# =============================================================================
# ANS-GO 一键升级脚本 (upgrade.sh)   v1.5.19
#
...
#   bash upgrade.sh [--docker | --metal] [--ver v1.5.19] [--yes]
#
...
#     启动后用 journalctl 日志行 "ansgo-panel v1.5.19 监听..." 验证版本
